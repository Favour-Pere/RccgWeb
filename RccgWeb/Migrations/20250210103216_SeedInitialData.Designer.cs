...
namespace RccgWeb.Migrations
{
    ...
    [Migration("20250210103216_SeedInitialData")]
            ...
            modelBuilder.Entity("RccgWeb.Models.Area", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AreaId = new Guid("90381266-3bb9-4963-9e8b-8780ef7f2465"),
                            AreaName = "Area X",
                            AreaPastor = "Pastor Smith",
                            ChurchId = "TBD",
                            DateCreated = new DateTime(2025, 2, 10, 10, 32, 15, 205, DateTimeKind.Utc).AddTicks(5895),
                            Location = "Location X",
                            ZoneId = new Guid("04118129-6f06-49e6-b155-1dd856347c2a")
                        });
                });
            ...
            modelBuilder.Entity("RccgWeb.Models.Parish", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ParishId = new Guid("7e5e6bc0-3981-4cb7-b73e-a2f2a2dc3bdc"),
                            AreaId = new Guid("90381266-3bb9-4963-9e8b-8780ef7f2465"),
                            ChurchId = "TBD",
                            DateCreated = new DateTime(2025, 2, 10, 10, 32, 15, 206, DateTimeKind.Utc).AddTicks(2296),
                            Location = "Location Y",
                            ParishName = "Parish 1",
                            ParishPastor = "Pastor Mark"
                        });
                });
            ...
            modelBuilder.Entity("RccgWeb.Models.Zone", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ZoneId = new Guid("04118129-6f06-49e6-b155-1dd856347c2a"),
                            ChurchId = "TBD",
                            DateCreated = new DateTime(2025, 2, 10, 10, 32, 15, 203, DateTimeKind.Utc).AddTicks(9689),
                            Location = "Location A",
                            ZoneName = "Zone A",
                        ...
                        new
                        {
                            ZoneId = new Guid("eb7cce28-a62a-4b40-8b35-31fd9a13aa14"),
                            ChurchId = "TBD",
                            DateCreated = new DateTime(2025, 2, 10, 10, 32, 15, 204, DateTimeKind.Utc).AddTicks(313),
                            Location = "Location B",
                            ZoneName = "Zone B",
