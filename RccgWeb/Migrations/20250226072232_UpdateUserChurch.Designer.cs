...
namespace RccgWeb.Migrations
{
    ...
    [Migration("20250226072232_UpdateUserChurch")]
    partial class UpdateUserChurch
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RccgWeb.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("RccgWeb.Models.UserChurch", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("RccgWeb.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("RccgWeb.Models.UserChurch", b =>
                {
                    b.HasOne("RccgWeb.Models.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
